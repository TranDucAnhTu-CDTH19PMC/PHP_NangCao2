...
<link rel="icon" href="<?php echo e(asset('assets/images/favicon.png')); ?>" type="image/x-icon">
    ...
    <!-- Feather icon-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('css/feather-icon.css')); ?>">
              ...
              <div class="col-xl-12 col-md-6 box-col-6 des-xl-50">
                <div class="card profile-greeting">
                  ...
                  <div class="card-body text-center p-t-0">
                    <h3 class="font-light">Wellcome Back, <?php echo e(auth()->user()->Ten); ?>!!</h3>
...
&lt;/div&gt;</code></pre>
    ...
    <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.masteradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Desktop/484_466_436_PHP/elearning/resources/views/admin/index.blade.php ENDPATH**/ ?>