...
<body>
        ...
        <div class="page-main-header">
            <div class="main-header-right row m-0">
                <div class="main-header-left">
                    <div class="logo-wrapper"><a href="https://laravel.pixelstrap.com/viho/dashboard"><img class="img-fluid" src="<?php echo e(asset('assets/images/logo/logo.png')); ?>" alt=""></a></div>
                    <div class="dark-logo-wrapper"><a href="https://laravel.pixelstrap.com/viho/dashboard"><img class="img-fluid" src="<?php echo e(asset('assets/images/logo/dark-logo.png')); ?>" alt=""></a></div>
        ...
        <div class="page-body-wrapper sidebar-icon">
            ...
            <header class="main-nav">
                <div class="sidebar-user text-center">
                    ...
                    <a href="user-profile">
                        <h6 class="mt-3 f-14 f-w-600"><?php echo e(auth()->user()->Ten); ?></h6>
                    </a>
                    <p class="mb-0 font-roboto"><?php echo e(auth()->user()->Email); ?></p>
                    <ul>
                        <li>
                            <span><span class=""><?php echo e($countAdmin); ?></span></span>
                            <p>Admin</p>
                        </li>
                        <li>
                            <span><span class=""><?php echo e($countTeacher); ?></span></span>
                            <p>Teacher</p>
                        </li>
                        <li>
                            <span><span class=""><?php echo e($countStudent); ?></span></span>
                            <p>Student</p>
                        </li>
                    </ul>
                </div>
                            ...
                            <ul class="nav-menu custom-scrollbar">
                                ...
                                <li class="dropdown">
                                    ...
                                    <ul class="nav-submenu menu-content" style="display: none;">
                                        <li><a href="<?php echo e(route('TeacherManagement')); ?>" class="">Teacher Management</a></li>
                                        <li><a href="<?php echo e(route('StudentManagement')); ?>" class="">Student Management</a></li>
                                        <li><a href="<?php echo e(route('classmanagement')); ?>" class="">Class Management</a></li>
    ...
    <!-- Plugin used-->
<?php /**PATH /Users/macbookair/Desktop/484_466_436_PHP/elearning/resources/views/layouts/masteradmin.blade.php ENDPATH**/ ?>