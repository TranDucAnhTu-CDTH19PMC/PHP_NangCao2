                      ...
                      <table class="display" id="example-style-1">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td><?php echo e($value->DanhsachLop->count()); ?></td>
                            <td> <a href="<?php echo e(route('ShowClass',['id'=>$value->id])); ?>"class="btn btn-primary" type="button">Show Class</a></td>
                            </tr>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.masteradmin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /Users/macbookair/Desktop/484_466_436_PHP/elearning/resources/views/admin/ClassManagement/ClassManagement.blade.php ENDPATH**/ ?>